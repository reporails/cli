...
- **Splitting documentation across files.** Creating both `SKILL.md` and `README.md` in the same skill directory. Agents only load `SKILL.md` — content in `README.md` is never seen.
