...
AI Instruction Diagnostics for coding agents. Reporails reads your instruction system — root instructions (`CLAUDE.md`, `.github/copilot-instructions.md`, `AGENTS.md`, `.cursorrules`, `GEMINI.md`) plus the rule, skill, sub-agent, and hook files alongside them — and runs 92+ deterministic rules to surface the vague directives, contradictions, oversized files, missing reinforcement, and cross-file conflicts that quietly degrade how reliably your agent follows you.
