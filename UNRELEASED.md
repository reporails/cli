...
### Added
- [ENGINE]: Add `file_absent` mechanical check — verifies a file does NOT exist (plain path or glob)
...
- [TESTS]: Update golden snapshots, scoring threshold, and smoke assertions for 0.5.0 rules
